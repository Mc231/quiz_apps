...
void main() {
  ...
  group('QuestionEntry', () {
    test(
      'QuestionEntry should serialize and deserialize correctly for TextQuestion',
      () {
        ...
        final reconstructed = QuestionEntry.fromJson(
          parsedJson,
          (json) => json,
        );
        ...
        expect(
          (reconstructed.type as TextQuestion).text,
    ...
    test(
      'QuestionEntry should serialize and deserialize correctly for ImageQuestion',
      () {
        final entry = QuestionEntry(
        ...
        expect(
          (reconstructed.type as ImageQuestion).imagePath,
