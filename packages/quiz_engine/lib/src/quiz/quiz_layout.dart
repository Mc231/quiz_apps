...
class QuizLayout extends StatelessWidget {
  ...
  ///
  /// This method creates the layout for the question content (image, text, audio, or video) and answer buttons,
  /// adjusting their arrangement based on the orientation of the screen.
  ///
